...
This layered standard provides the capability to include additional related files, as well as multiple experiment setups, including experiment-related settings, parameter sets, and referece inputs and outputs, in an FMU.
