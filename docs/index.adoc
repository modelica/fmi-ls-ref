...
* defines how to provide basic experiments with stimuli and reference results for limited re-validation purposes.
* provides files related to the FMU and defines their role such as parameter sets.
