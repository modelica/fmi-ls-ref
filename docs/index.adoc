= Layered Standard References (FMI-LS-REF)
:sectnums:
:sectnumlevels: 5
:toc: left
:toc-title: Contents
...
|`experiment`
| Experiment file, e.g., an experiment setup in the format described in https://github.com/modelica/ma-hs-experiments[MA-HS-Experiments], that can be used to perform basic validation (i.e. a smoke test) of the FMU in a simulation environment.
...
For files with type `application/x-ma-hs-experiments`, the experiment is performed as specified in https://github.com/modelica/ma-hs-experiments[MA-HS-Experiments], using the format defined therein.
...
- [[[MA-HS-Experiments]]] Modelica Association Harmonized Specification: Experiments Format. https://github.com/modelica/ma-hs-experiments
